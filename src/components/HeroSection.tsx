    ...
    <div className='h-auto md:h-[46rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0'>
      ...
      />
        <div className='p-4 relative z-10 w-full text-center'>
            ...
            <p className='mt-4 font-normal text-base text-neutral-300 max-w-lg mx-auto'>Musical journey brings up a state of spirituality within an individual which then leads to feel the presence of divine around one.</p>
